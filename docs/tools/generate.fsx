...
let website = "/SportsDataTracker"

let githubLink = "http://github.com/pver/SportsDataTracker"

// Specify more information about your project
let info =
  [ "project-name", "SportsDataTracker"
    "project-author", "Peter Vermeulen"
    "project-summary", "An application and library that allows analyzing sports data."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/SportsDataTracker" ]
